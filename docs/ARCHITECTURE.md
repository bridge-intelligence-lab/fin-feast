...
This document describes the system architecture for Fin Feast, including batch (offline-first) and streaming minute-bar ingestion paths, data zones, and how features flow to the online store for inference.
